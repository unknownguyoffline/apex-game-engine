...
void EditorLayer::onAttach()
{
    ...
    IMGUI_CHECKVERSION();
    ImGui::CreateContext();
    ImGui::GetIO().Fonts->AddFontFromFileTTF("/usr/share/fonts/truetype/cascadia/ttf/CascadiaCode.ttf", 24);
...
void EditorLayer::onUpdate()
{
    ...
    glfwMakeContextCurrent((GLFWwindow *)Application::get()->getNativeWindow());
}
